...
ngx.timer.at(0, function(premature)
    ...
    local seed_globos = {
        ...
        { path = "/static/globos/defaults/location2.webp",    lat =  41.3880330, lon = 2.1117172  },
        { path = "/static/globos/defaults/location3.webp",    lat =  41.3886677, lon = 2.1109759  },
        { path = "/static/globos/defaults/location4.webp",    lat =  41.3881492, lon = 2.1139274  }
    }
